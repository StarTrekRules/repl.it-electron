...
/* Declare Constants */
let mainWindow;
let subWindow = require('./store/store').state.subWindow;
...
let logger = require('./store/logger');logger("thing");
/* App SetUp's */
...
async function appSetup() {
    ...
    let viewMenuTemplate = require('./menu-template/view')(
        mainWindow,
        subWindow
    );
...
let startSubWindow = require('./store/store').methods.startSubWindow;
...
let createWindow = store.methods.createWindow;
